torchrun --nnodes=1 --nproc_per_node=8 --master_port 23432 timm_train.py \
    ...
    --mask-only \
    --sparse-checkpoint /home/chenzhiqiang/MaskLLM-4V/output/pruned/deit_small_patch16_224.augreg_in1k.sparsegpt24.pt \
    -b 128 \
    --opt adamw \
    --lr 1e-3 \
    --weight-decay 0.01 \
    ...
    --mean 0.5 0.5 0.5 \
    --std 0.5 0.5 0.5 \
    --output output/maskllm_deit_small_patch16_224.augreg_in1k.magnitude24 \
